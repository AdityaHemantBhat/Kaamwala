      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: 24, paddingBottom: 40, gap: 20 }}>
        <View>
          ...
          <View style={{ backgroundColor: '#FFF', borderRadius: 12, elevation: 1, overflow: 'hidden' }}>
            <Pressable style={{ flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#F0EBE0' }} onPress={() => router.push('/(worker)/profile')}>
              <MaterialCommunityIcons name="account-circle-outline" size={22} color="#0D0D0D" />
              <Text style={{ fontFamily: 'Inter_400Regular', fontSize: 14, color: '#0D0D0D', flex: 1, marginLeft: 12 }}>{t('Profile')}</Text>
              <MaterialCommunityIcons name="chevron-right" size={18} color="#C8C0B0" />
            </Pressable>
            <Pressable style={{ flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#F0EBE0' }} onPress={() => router.push('/(worker)/subscription')}>
              <MaterialCommunityIcons name="crown-outline" size={22} color="#D4A017" />
              <Text style={{ fontFamily: 'Inter_400Regular', fontSize: 14, color: '#0D0D0D', flex: 1, marginLeft: 12 }}>{t('Upgrade Plan')}</Text>
              <MaterialCommunityIcons name="chevron-right" size={18} color="#C8C0B0" />
            </Pressable>
            <Pressable style={{ flexDirection: 'row', alignItems: 'center', padding: 16 }} onPress={() => setShowLang(true)}>
              ...
              <Text style={{ fontFamily: 'Inter_400Regular', fontSize: 12, color: '#9E9E9E', marginRight: 8 }}>{currentLang?.native || 'English'}</Text>
              <MaterialCommunityIcons name="chevron-right" size={18} color="#C8C0B0" />
            </Pressable>
          </View>
        </View>
        ...
        <View>
          ...
          <View style={{ backgroundColor: '#FFF', borderRadius: 12, elevation: 1, overflow: 'hidden' }}>
            <Pressable style={{ flexDirection: 'row', alignItems: 'center', padding: 16 }} onPress={() => router.push('/(worker)/support')}>
        ...
        <View>
          ...
          <View style={{ backgroundColor: '#FFF', borderRadius: 12, elevation: 1, overflow: 'hidden' }}>
            ...
            <Pressable style={{ flexDirection: 'row', alignItems: 'center', padding: 16 }} onPress={() => router.push('/(worker)/terms')}>
